...
def main():
    ...
    # path = os.path.join(args.data_dir, "*/*.wav")
    # print(f"args.data_dir: {path}")
    data = load_data(
...
def save_model(mp_trainer, opt, step):
    if dist.get_rank() == 0:
        th.save(
            ...
            os.path.join(logger.get_dir(), f"classifier_model{step:06d}.pt"),
        )
        th.save(opt.state_dict(), os.path.join(logger.get_dir(), f"classifier_opt{step:06d}.pt"))
